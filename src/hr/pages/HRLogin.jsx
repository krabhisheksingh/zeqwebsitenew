...
export default function HRLogin() {
  ...
  useEffect(() => {
    seedInitialData().finally(() => setSeeding(false));
  }, []);
  ...
  const submit = async (e) => {
    ...
    try {
      const emp = await findEmployee(form.username, form.password);
      if (emp) {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="rounded-3xl border border-border/40 bg-card/60 backdrop-blur-xl shadow-2xl p-8">
          ...
          {seeding && (
            <div className="text-center text-foreground/40 text-sm py-4">Connecting to server...</div>
          )}
            ...
            <form onSubmit={submit} className="flex flex-col gap-5">
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    name="username" value={form.username} onChange={handle} required autoComplete="username"
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handle} required autoComplete="current-password" placeholder="Enter your password"
              ...
              {error && (
                <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                  className="text-red-500 text-sm bg-red-500/10 border border-red-500/20 rounded-xl px-4 py-2.5">
                  {error}
                </motion.p>
              )}
